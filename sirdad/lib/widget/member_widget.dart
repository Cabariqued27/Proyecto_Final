                ...
                children: <Widget>[
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:
                            'tipo de documento: 1. registro civil 2.tarjeta de identidad 3.cedula de ciudadania 4.cedulan de extranjera 5.indocumentado 6.no sabe/no responde'),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:
                            'parentesco con el jefe de hogar: 1. jefe de hogar 2.esposo(a) 3.hijo(a) 4.primo(a) 5.tio(a) 6.nieto(a) 7.suegro(a) 8.yerno/nuera'),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Por favor, ingresa un valor válido.';
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:
                            'Etnia : 1. afrocolombiano 2.indigena 3.Gitano 4.Razial 5.Otro 6.sin informacion'),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Por favor, ingresa un valor válido.';
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:
                            'Estado de salud: 1.Requiere asistencia 2.no requiere asistencia medica'),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Por favor, ingresa un valor válido.';
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:
                            'Afiliacion al regimen de salud: 1.contributivo 2.subsidio 3.sin afilicion'),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Por favor, ingresa un valor válido.';
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                        labelText:
                            'Estado del inmueble 1. habitable 2.no habitable 3.destruida'),
                    keyboardType: TextInputType.number,
                    validator: (value) {
                      if (value!.isEmpty) {
                        return 'Por favor, ingresa un valor válido.';
